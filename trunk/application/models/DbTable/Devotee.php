...
class Application_Model_DbTable_Devotee extends Zend_Db_Table_Abstract
{
    ...
    public function getDevotees($limit,$offset){
        $select = $this->_db->select();
   		$select->from(array('d'=>'devotee'),array('d.did', 'd.initiated_name','d.first_name','d.middle_name','d.last_name', 'd.display_name', 'd.do_birth' , 'd.gender', 'd.center_id', 'd.counselor_id', 'd.ast_counselor_id', 'd.mobile', 'd.email', 'd.blood_group', 'd.pics', 'd.devotee_status'))	
